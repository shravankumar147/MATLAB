...
MODEL  = familyRadioServiceExample
TARGET = cgxe
MODULE_SRCS 	= m_5ndm3t6eGrpAcmOsRijoGB.c m_SY2m30lpuXg1s83zafIs8.c m_FztNqarQ80TA694cfZ23r.c m_y5kHx03bfD5aWnMIivTskD.c
MODEL_SRC	= familyRadioServiceExample_cgxe.c
MODEL_REG = familyRadioServiceExample_cgxe_registry.c
MAKEFILE    = familyRadioServiceExample_cgxe.mak
...
OBJLIST_FILE = familyRadioServiceExample_cgxe.mol
