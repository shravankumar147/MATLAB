...
static void SampleRateConverter_stepImpl(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance, dsp_SampleRateConverter_2 *obj, real_T u[6250], real_T y[1000]);
static void SystemCore_step(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance, dspcodegen_FIRDecimator *obj, real_T varargin_1[6250], real_T
  varargout_1[1250]);
static void cgxe_mdl_start(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance);
static const mxArray *message(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance, const mxArray *b, const mxArray *c, emlrtMCInfo *location);
static void error(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance, const
                  mxArray *b, emlrtMCInfo *location);
static const mxArray *b_message(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance, const mxArray *b, emlrtMCInfo *location);
static void init_simulink_io_address(InstanceStruct_5ndm3t6eGrpAcmOsRijoGB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S, int_T tid)
{
  InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance =
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S)
{
  InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance =
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S, int_T tid)
{
  InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance =
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S)
{
  InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance =
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S)
{
  InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *moduleInstance =
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB *)calloc(1, sizeof
    (InstanceStruct_5ndm3t6eGrpAcmOsRijoGB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetSimStateCompliance(S, DISALLOW_SIM_STATE);
  ssSetmdlOutputs(S, mdlOutputs_5ndm3t6eGrpAcmOsRijoGB);
  ssSetmdlInitializeConditions(S, mdlInitialize_5ndm3t6eGrpAcmOsRijoGB);
  ssSetmdlUpdate(S, mdlUpdate_5ndm3t6eGrpAcmOsRijoGB);
  ssSetmdlTerminate(S, mdlTerminate_5ndm3t6eGrpAcmOsRijoGB);
...
static void mdlProcessParameters_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S)
{
}

void method_dispatcher_5ndm3t6eGrpAcmOsRijoGB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_5ndm3t6eGrpAcmOsRijoGB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_5ndm3t6eGrpAcmOsRijoGB(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 5ndm3t6eGrpAcmOsRijoGB.\n"
...
mxArray *cgxe_5ndm3t6eGrpAcmOsRijoGB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
