...
static void SystemCore_release(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, dsp_private_DownConverterFilterDesigner_2 *obj);
static void SystemCore_validateProperties(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *
  moduleInstance, dsp_DigitalDownConverter_2 *obj);
static void DigitalDownConverter_stepImpl(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *
...
static void DigitalDownConverter_getOscillatorSignalFromObject
  (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance,
   dsp_DigitalDownConverter_2 *obj, creal_T dataOut[250000]);
static void DigitalDownConverter_mixer(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, dsp_DigitalDownConverter_2 *obj, real_T dataIn[250000],
  creal_T oscData[250000], creal_T dataOut[250000]);
static void SystemCore_step(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, dspcodegen_FIRDecimator_1 *obj, creal_T varargin_1[250000],
  creal_T varargout_1[25000]);
static void b_SystemCore_step(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
...
static void cgxe_mdl_start(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance);
static const mxArray *message(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, const mxArray *c, const mxArray *d, emlrtMCInfo *location);
static void error(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance, const
                  mxArray *c, emlrtMCInfo *location);
static const mxArray *b_message(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, const mxArray *c, const mxArray *d, const mxArray *e,
  emlrtMCInfo *location);
static const mxArray *c_message(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance, const mxArray *c, emlrtMCInfo *location);
static void init_simulink_io_address(InstanceStruct_r5cGeKo98ybkLIRW3mgHRE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S, int_T tid)
{
  InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance =
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S)
{
  InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance =
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S, int_T tid)
{
  InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance =
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S)
{
  InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance =
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S)
{
  InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *moduleInstance =
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE *)calloc(1, sizeof
    (InstanceStruct_r5cGeKo98ybkLIRW3mgHRE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetSimStateCompliance(S, DISALLOW_SIM_STATE);
  ssSetmdlOutputs(S, mdlOutputs_r5cGeKo98ybkLIRW3mgHRE);
  ssSetmdlInitializeConditions(S, mdlInitialize_r5cGeKo98ybkLIRW3mgHRE);
  ssSetmdlUpdate(S, mdlUpdate_r5cGeKo98ybkLIRW3mgHRE);
  ssSetmdlTerminate(S, mdlTerminate_r5cGeKo98ybkLIRW3mgHRE);
...
static void mdlProcessParameters_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S)
{
}

void method_dispatcher_r5cGeKo98ybkLIRW3mgHRE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_r5cGeKo98ybkLIRW3mgHRE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_r5cGeKo98ybkLIRW3mgHRE(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: r5cGeKo98ybkLIRW3mgHRE.\n"
...
mxArray *cgxe_r5cGeKo98ybkLIRW3mgHRE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
