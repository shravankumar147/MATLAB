...
MODEL                  = vdp
MODULES                = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c vdp_capi.c vdp_data.c vdp_tgtconn.c 
MAKEFILE               = vdp.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = D:\work2015\2015\March\CITD_proj\proj_expo\Tutorial\Digital Electronics
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\vdp

MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)

MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\simulink\simdemos\simgeneral
