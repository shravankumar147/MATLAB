...
const rtS = & model_S ; void MdlInitialize ( void ) { rtX . gq0u3r51ae = rtP
. x1_IC ; rtX . bxm4duvtnu = rtP . x2_IC ; } void MdlStart ( void ) {
MdlInitialize ( ) ; } void MdlOutputs ( int_T tid ) { rtB . dd2tkjygng = rtX
. gq0u3r51ae ; rtY . knrqyxbhzu = rtB . dd2tkjygng ; rtB . hlljur0dk4 = rtX .
bxm4duvtnu ; rtY . moq0w12ulw = rtB . hlljur0dk4 ; rtB . jre4cphv4k = ( 1.0 -
rtB . dd2tkjygng * rtB . dd2tkjygng ) * rtB . hlljur0dk4 * rtP . Mu_Gain -
rtB . dd2tkjygng ; UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid )
{ UNUSED_PARAMETER ( tid ) ; } void MdlDerivatives ( void ) { { ( ( XDot * )
ssGetdX ( rtS ) ) -> gq0u3r51ae = rtB . hlljur0dk4 ; } { ( ( XDot * ) ssGetdX
( rtS ) ) -> bxm4duvtnu = rtB . jre4cphv4k ; } } void MdlProjection ( void )
...
, 0 ) ; ssSetNumSampleTimes ( rtS , 1 ) ; ssSetNumBlocks ( rtS , 9 ) ;
ssSetNumBlockIO ( rtS , 3 ) ; ssSetNumBlockParams ( rtS , 3 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetOffsetTime ( rtS , 0 , 0.0 ) ; } void raccel_set_checksum ( SimStruct *
rtS ) { ssSetChecksumVal ( rtS , 0 , 2093421753U ) ; ssSetChecksumVal ( rtS ,
1 , 2683934868U ) ; ssSetChecksumVal ( rtS , 2 , 220658665U ) ;
ssSetChecksumVal ( rtS , 3 , 4146926758U ) ; } SimStruct *
...
{ rtB . dd2tkjygng = 0.0 ; rtB . hlljur0dk4 = 0.0 ; rtB . jre4cphv4k = 0.0 ;
} } { ssSetY ( rtS , & rtY ) ; rtY . knrqyxbhzu = 0.0 ; rtY . moq0w12ulw =
...
ssSetChecksumVal ( rtS , 0 , 2093421753U ) ; ssSetChecksumVal ( rtS , 1 ,
2683934868U ) ; ssSetChecksumVal ( rtS , 2 , 220658665U ) ; ssSetChecksumVal
( rtS , 3 , 4146926758U ) ; { static const sysRanDType rtAlwaysEnabled =
