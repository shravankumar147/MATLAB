...
MODEL  = commqamtxrxhdl
TARGET = cgxe
MODULE_SRCS 	= m_J7aWBDqExLqAyGE5Qpg8zG.c m_wNselC31AbXio1ZnIoqGEG.c
MODEL_SRC	= commqamtxrxhdl_cgxe.c
MODEL_REG = commqamtxrxhdl_cgxe_registry.c
MAKEFILE    = commqamtxrxhdl_cgxe.mak
...
OBJLIST_FILE = commqamtxrxhdl_cgxe.mol
